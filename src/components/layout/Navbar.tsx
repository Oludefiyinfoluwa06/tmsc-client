          ...
          <nav className="hidden md:flex items-center gap-10">
            ...
            <div className="group relative">
              ...
              <div className="absolute left-0 mt-0 w-48 bg-black/90 border border-white/20 rounded-lg shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 py-2 z-50 backdrop-blur">
                <Link to="/for-governments" className={`block px-4 py-3 text-sm no-underline transition-colors duration-300 font-medium ${isActive('/for-governments') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For Governments</Link>
                <Link to="/for-investors" className={`block px-4 py-3 text-sm no-underline transition-colors duration-300 font-medium ${isActive('/for-investors') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For Investors</Link>
                <Link to="/for-oems" className={`block px-4 py-3 text-sm no-underline transition-colors duration-300 font-medium ${isActive('/for-oems') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For OEMs</Link>
                <Link to="/for-local" className={`block px-4 py-3 text-sm no-underline transition-colors duration-300 font-medium ${isActive('/for-local') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For Local Industry</Link>
              </div>
            </div>
          </nav>
            ...
            <div className="flex flex-col gap-1 py-4">
              ...
              <div>
                <button
                  ...
                  className="w-full text-sm font-semibold text-white no-underline px-4 py-3 hover:bg-white/10 hover:text-white transition-colors duration-300 rounded-lg flex items-center justify-between"
                >
                  Solutions
                ...
                {solutionsDropdownOpen && (
                  <div className="flex flex-col gap-1 bg-white/5 rounded-lg mt-1 ml-4 py-2">
                    <Link to="/for-governments" onClick={closeMobileMenu} className={`text-sm font-medium no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/for-governments') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For Governments</Link>
                    <Link to="/for-investors" onClick={closeMobileMenu} className={`text-sm font-medium no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/for-investors') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For Investors</Link>
                    <Link to="/for-oems" onClick={closeMobileMenu} className={`text-sm font-medium no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/for-oems') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For OEMs</Link>
                    <Link to="/for-local" onClick={closeMobileMenu} className={`text-sm font-medium no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/for-local') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>For Local Industry</Link>
                  </div>
                )}
              </div>
              
              <Link to="/products" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/products') ? 'text-red-600 bg-red-600/10' : 'text-white hover:bg-white/10 hover:text-white'}`}>Products</Link>
            </div>
