      ...
      <div className="px-6 md:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <Link to="/" className={`text-sm font-semibold no-underline transition-colors duration-300 relative after:absolute after:bottom-0 after:left-0 after:h-0.5 after:bg-primary-500 after:transition-all after:duration-300 ${isActive('/') ? 'text-gray-900 after:w-full' : 'text-gray-600 hover:text-gray-900 after:w-0 hover:after:w-full'}`}>Home</Link>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden pb-6 border-t border-gray-200 bg-white shadow-xl mb-4 rounded-lg">
            <div className="flex flex-col gap-1 py-4">
              <Link to="/" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/') ? 'text-primary-600 bg-primary-600/10' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>Home</Link>
              <Link to="/about" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/about') ? 'text-primary-600 bg-primary-600/10' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>About</Link>
              <Link to="/digital-production-nodes" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/digital-production-nodes') ? 'text-primary-600 bg-primary-600/10' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>Digital Production Nodes</Link>
              <Link to="/operations" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/operations') ? 'text-primary-600 bg-primary-600/10' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>Operations</Link>
              <Link to="/projects" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/projects') ? 'text-primary-600 bg-primary-600/10' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>Projects</Link>
              <Link to="/partners" onClick={closeMobileMenu} className={`text-sm font-semibold no-underline px-4 py-3 transition-colors duration-300 rounded-lg ${isActive('/partners') ? 'text-primary-600 bg-primary-600/10' : 'text-gray-700 hover:bg-gray-100 hover:text-gray-900'}`}>Partners</Link>
            </div>
            <div className="flex flex-col gap-2 pt-4 px-4 border-t border-gray-200">
              ...
              <Link to="/contact" onClick={closeMobileMenu} className="text-sm font-semibold text-white no-underline px-4 py-2.5 bg-primary-600 rounded-lg transition-all duration-300 hover:bg-primary-700 text-center">Join Waitlist</Link>
            </div>
          </nav>
        )}
      </div>
