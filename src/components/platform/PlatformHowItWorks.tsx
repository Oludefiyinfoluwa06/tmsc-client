    ...
    <section className="py-32 bg-black/50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 relative z-10">
        <div className="text-center mb-20">
          <p className="text-primary-400 text-sm font-semibold uppercase tracking-widest mb-3">Process</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            ...
            <div key={item.step} className="relative group">
              ...
              <div className="bg-linear-to-br from-white/10 to-white/5 rounded-2xl p-8 border border-white/20 backdrop-blur-xl hover:border-primary-600/50 transition-all duration-300 group-hover:-translate-y-2 h-full">
