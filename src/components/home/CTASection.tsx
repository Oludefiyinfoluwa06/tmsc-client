      ...
      <div className="max-w-5xl mx-auto px-6 md:px-8 animate-fade-in-up">
        <div className="bg-gray-50 border border-gray-100 rounded-3xl p-12 md:p-16 text-center relative overflow-hidden shadow-xl">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-semibold text-base cursor-pointer bg-primary-600 text-white transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1 hover:bg-primary-700 animate-slide-in-left" to="/contact">
              Start Skill Program
              <ArrowRight size={18} />
            </Link>
          </div>
