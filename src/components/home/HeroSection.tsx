  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center text-white pt-20 overflow-hidden" style={{ paddingTop: '15px' }}>
      ...
      <div className="relative z-20 w-full mx-auto px-6 md:px-8 text-left mt-30">
        <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 border border-primary-500/50 rounded-full backdrop-blur animate-fade-in-up">
          <Zap size={16} className="text-primary-400" />
          <span className="text-primary-300 text-sm font-semibold">Industrial Transformation Initiative</span>
        </div>

        <h1 className="text-6xl md:text-8xl font-bold leading-tight mb-8 animate-fade-in-up">
          Connect Your Industrial <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-primary-400 via-emerald-400 to-cyan-400">Capacity Today</span>
        </h1>
        ...
        <div className="flex gap-4 flex-wrap mb-40 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
          <Link className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-semibold text-white bg-primary-600 transition-all duration-300 shadow-xl hover:shadow-2xl hover:-translate-y-1 hover:bg-primary-700" to="/machine-exchange-program">
            Start Skill Program
            <ArrowRight size={20} />
          </Link>
