      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="bg-gray-50 border border-gray-100 rounded-2xl p-12 md:p-16 shadow-lg">
          <div className="text-center mb-16">
            <p className="text-primary-600 text-sm font-semibold mb-3">EXECUTION TRACK RECORD</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            {[
              ...
              <div key={idx} className="bg-gray-50 border border-gray-100 rounded-xl p-8 hover:border-primary-500/50 hover:bg-white hover:shadow-lg transition-all duration-300 group">
                <p className="text-4xl font-bold text-primary-600 group-hover:text-primary-500 transition-colors duration-300 mb-2">{item.stat}</p>
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {[
              ...
              <div key={idx} className="border-l-4 border-primary-600 pl-6 py-4 hover:border-primary-500 transition-colors duration-300">
