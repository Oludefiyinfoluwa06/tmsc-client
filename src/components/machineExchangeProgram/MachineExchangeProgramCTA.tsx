    ...
    <section className="py-32 bg-linear-to-b from-black to-black relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 md:px-8 relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-primary-600 text-white font-semibold rounded-lg hover:bg-primary-700 transition-all duration-300 shadow-xl hover:shadow-primary-600/50 hover:-translate-y-1" to="/contact">
           Contact
            <ArrowRight size={20} />
          </Link>
