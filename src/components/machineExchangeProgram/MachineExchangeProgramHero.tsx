    ...
    <section className="relative min-h-screen flex items-center justify-center text-white pt-20 overflow-hidden" style={{ paddingTop: '15px' }}>
      ...
      <div className="relative z-20 w-full mx-auto px-6 md:px-8 text-left mt-30">
        <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 border border-primary-500/50 rounded-full backdrop-blur">
          ...
          <span className="text-primary-300 text-sm font-semibold">Industrial Transformation</span>
        </div>

        <h1 className="text-6xl md:text-8xl font-bold leading-tight mb-8 animate-fade-in-up">
          Machine Exchange <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-primary-400 via-emerald-400 to-cyan-400">Program</span>
        </h1>
