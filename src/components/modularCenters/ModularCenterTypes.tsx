  ...
  return (
    <section className="py-32 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 relative z-10">
          ...
          <p className="text-primary-600 text-sm font-semibold uppercase tracking-widest mb-3">Options</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={idx} className="group relative">
              <div className="absolute inset-0 bg-linear-to-br from-primary-500/10 to-blue-500/10 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
              <div className="relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-primary-500/30 transition-all duration-300 group-hover:-translate-y-2 h-full shadow-sm hover:shadow-lg">
                <div className="mb-4"><type.Icon className="text-primary-600" size={36} /></div>
                ...
                <ul className="space-y-2">
                  {type.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-2">
                      <span className="text-primary-600 text-lg mt-0">▸</span>
