    ...
    <section className="py-32 bg-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-8 relative z-10">
        <div className="text-center mb-20">
          <p className="text-primary-600 text-sm font-semibold uppercase tracking-widest mb-3">Value Proposition</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            ...
            <div key={idx} className="group relative">
              ...
              <div className="relative bg-white rounded-2xl p-8 border border-gray-100 hover:border-primary-500/30 transition-all duration-300 group-hover:-translate-y-2 text-center flex items-center justify-center flex-col shadow-sm hover:shadow-lg">
                <div className="mb-6"><reason.Icon className="text-primary-600" size={48} /></div>
