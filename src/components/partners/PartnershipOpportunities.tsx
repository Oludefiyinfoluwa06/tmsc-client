    ...
    <section className="py-32 bg-white">
      <div className="max-w-6xl mx-auto px-6 md:px-8">
        <div className="text-center mb-20">
          <p className="text-primary-600 text-sm font-semibold uppercase tracking-widest mb-3">Opportunities</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {[
            ...
            <div key={idx} className="group relative">
              ...
              <div className="relative bg-gray-50 rounded-2xl p-8 border border-gray-100 hover:border-primary-500/30 transition-all duration-300 group-hover:-translate-y-2 shadow-sm hover:shadow-lg">
                <div className="mb-4"><partnership.Icon className="text-primary-600" size={36} /></div>
