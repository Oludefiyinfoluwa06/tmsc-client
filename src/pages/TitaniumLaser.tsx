      ...
      <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden" style={{ paddingTop: '15px' }}>
        ...
        <div className="relative z-20 w-full mx-auto px-6 md:px-8 text-left pt-20">
          <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 border border-primary-500/50 rounded-full backdrop-blur">
            ...
            <span className="text-primary-300 text-sm font-semibold">Advanced Laser Systems</span>
          </div>

          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 animate-fade-in-up">
            Titanium <br /><span className="text-transparent bg-clip-text bg-linear-to-r from-primary-400 via-emerald-400 to-cyan-400">Laser</span>
          </h1>
          ...
          <p className="text-base md:text-lg text-white/90 mb-10 max-w-2xl leading-relaxed animate-fade-in-up" style={{animationDelay: '0.1s'}}>
            Multi-function laser systems with comprehensive support.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description: 'Enablement through live production workflows.'
              },
              {
                icon: Award,
              ...
              return (
                <div key={idx} className="bg-gray-50 border border-gray-800 rounded-lg p-8 hover:border-primary-500/50 transition-all">
      ...
      <section className="py-16 md:py-24 bg-white border-y border-gray-800">
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <Link
              to="/contact"
              className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-linear-to-r from-primary-600 to-primary-500 text-white font-semibold rounded-lg hover:from-primary-700 hover:to-primary-600 transition-all"
            >
              Contact
              <ArrowRight size={20} />
            </Link>
