      ...
      <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden" style={{ paddingTop: '15px' }}>
        ...
        <div className="relative z-20 w-full mx-auto px-6 md:px-12 text-left pt-20 max-w-5xl">
          <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 border border-primary-500/40 rounded-full backdrop-blur">
            <span className="text-primary-300 text-xs font-semibold tracking-widest uppercase">Equipment Exchange</span>
          </div>

          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 tracking-tight">Equipment Exchange Program</h1>
          <h2 className="text-base md:text-lg text-primary-300 font-light mb-6 tracking-wider">Bridging the Technology Gap</h2>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all">
              <div className="w-10 h-10 bg-primary-600 text-white rounded-full flex items-center justify-center font-bold mb-4">1</div>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all">
              <div className="w-10 h-10 bg-primary-600 text-white rounded-full flex items-center justify-center font-bold mb-4">2</div>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all">
              <div className="w-10 h-10 bg-primary-600 text-white rounded-full flex items-center justify-center font-bold mb-4">3</div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <h4 className="text-lg font-bold text-primary-600 mb-3">Advanced Technology</h4>
                <p className="text-gray-700">Access to cutting-edge machinery and tools.</p>
              </div>

              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <h4 className="text-lg font-bold text-primary-600 mb-3">Cost-Effective</h4>
                <p className="text-gray-700">Affordable upgrade options that fit your budget.</p>
              </div>

              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <h4 className="text-lg font-bold text-primary-600 mb-3">Productivity Boost</h4>
                <p className="text-gray-700">Enhanced efficiency and output quality.</p>
              </div>
            </div>
          </div>

          <div className="mt-12 p-8 bg-linear-to-r from-primary-50 to-primary-100 border border-primary-200 rounded-lg">
