      ...
      <section className="py-20 md:py-32 bg-white">
        <div className="max-w-6xl mx-auto px-6 md:px-8">
          <div className="text-center mb-16">
            ...
            <div className="w-16 h-1 bg-linear-to-r from-primary-600 to-primary-600/20 mx-auto"></div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            {[
              ...
              return (
                <div key={idx} className="group relative bg-white border border-gray-200 rounded-2xl p-8 hover:border-primary-500/30 hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                  <div className="absolute inset-0 bg-linear-to-br from-primary-500/5 to-transparent rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300"></div>
      ...
      <section className="py-20 md:py-32 bg-gray-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 relative z-10">
          <div className="text-center mb-16">
            ...
            <div className="w-16 h-1 bg-linear-to-r from-primary-600 to-primary-600/20 mx-auto mt-4"></div>
          </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-10 md:p-12 mb-12 shadow-sm hover:shadow-md transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                <div key={idx} className="pl-6 border-l-4 border-primary-600">
          ...
          <div className="flex gap-4 flex-wrap justify-center">
            <Link to="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-lg font-semibold text-white bg-linear-to-r from-primary-600 to-primary-500 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1">
              Deploy a Digital Production Node
              <ArrowRight size={20} />
            </Link>
            <div className="inline-flex items-center gap-4 text-sm">
              <Link to="/operations" className="text-gray-700 font-medium hover:text-primary-600 transition-colors">View Operational Nodes</Link>
              <span className="text-gray-300">•</span>
              <Link to="/projects" className="text-gray-700 font-medium hover:text-primary-600 transition-colors">See Deployed Systems</Link>
            </div>
          </div>
        </div>
      </section>
