      ...
      <section className="relative min-h-screen flex items-center justify-center text-white overflow-hidden" style={{ paddingTop: '15px' }}>
        ...
        <div className="relative z-20 w-full mx-auto px-6 md:px-12 text-left pt-20 max-w-5xl">
          <div className="mb-8 inline-flex items-center gap-2 px-4 py-2 bg-primary-500/20 border border-primary-500/40 rounded-full backdrop-blur">
            <span className="text-primary-300 text-xs font-semibold tracking-widest uppercase">Data Solutions</span>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all">
              <h4 className="text-lg font-bold text-primary-600 mb-3">Advanced Solutions</h4>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all">
              <h4 className="text-lg font-bold text-primary-600 mb-3">Seamless Integration</h4>
            ...
            <div className="p-6 bg-white border border-gray-200 rounded-lg hover:shadow-lg transition-all">
              <h4 className="text-lg font-bold text-primary-600 mb-3">Customizable</h4>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <h4 className="text-lg font-bold text-primary-600 mb-3">Data Accuracy</h4>
                <p className="text-gray-700">Minimize errors and inconsistencies in your data collection processes.</p>
              </div>

              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <h4 className="text-lg font-bold text-primary-600 mb-3">Operational Efficiency</h4>
                <p className="text-gray-700">Streamline workflows and reduce manual effort with automated solutions.</p>
              </div>

              <div className="p-6 bg-white border border-gray-200 rounded-lg">
                <h4 className="text-lg font-bold text-primary-600 mb-3">Data Security</h4>
